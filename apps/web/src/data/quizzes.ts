...
export const QUIZZES: Quiz[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "TRX es la criptomoneda nativa de la blockchain TRON, fundada por Justin Sun — podés ver su ficha completa en la sección TRON.",
      },
      {
        question: "¿Qué es un exchange centralizado (CEX)?",
        options: [
          "Un tipo de wallet física",
          "Una plataforma donde comprás y vendés cripto, como Binance",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "Con un ratio riesgo/beneficio de 1:2, ¿qué win rate mínimo necesitás para no perder dinero?",
        options: ["Alrededor de 33%", "Alrededor de 90%", "Exactamente 100%", "Alrededor de 66%"],
        correctIndex: 0,
        explanation: "Win rate mínimo = 1 / (1 + ratio) = 1/3 ≈ 33.3% — con 1:2 podés perder 2 de cada 3 trades y seguir siendo rentable.",
      },
      {
        question: "Si tu cuenta cae -50%, ¿qué % de ganancia necesitás para volver al balance inicial?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "Si arriesgás 8% de tu cuenta en un solo trade en la Terminal, ¿qué tipo de feedback vas a recibir al cerrarlo?",
        options: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "Es el espacio de práctica: mismos datos e indicadores que el resto del dashboard, pero sin plata real en juego — el error ahí es la lección más barata que existe.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        options: [
          ...
          "En spot sos dueño del activo real; en futuros tenés una posición sobre su precio, sin poseerlo",
          "Los futuros solo existen para TRX, no para BTC",
          "No hay ninguna diferencia real",
        ],
        correctIndex: 1,
        explanation: "En spot el BTC entra a tu wallet, sos dueño de algo real. En futuros nunca posees el activo — solo una posición sobre su precio, lo que te permite apostar tanto a que sube como a que baja.",
      },
      {
        question: "¿Cuándo ganás dinero en una posición SHORT?",
        options: [
        ...
        correctIndex: 1,
        explanation: "El short es apostar a la baja: ganás cuando el precio cae. Es lo opuesto al long y algo que en spot es imposible (a lo sumo evitás una pérdida si no vendés).",
      },
      {
        question: "Abrís una posición con 10x de apalancamiento y el precio se mueve 2% en tu contra. ¿Aproximadamente qué % de tu margen perdés?",
        options: ["2%", "10%", "20%", "0.2%"],
        correctIndex: 2,
      ...
      {
        question: "Querés abrir una posición de $5,000 de exposición con 25x de apalancamiento. ¿Cuánto margen necesitás bloquear?",
      ...
      },
      {
        ...
        options: [
          ...
          "Si te liquidan, solo perdés el margen de esa posición puntual — el resto de tu cuenta queda a salvo",
      ...
      {
        question: "Entrás LONG con $200 de margen a 10x en BTC a $63,000. Usando un margen de mantenimiento aproximado de 0.5%, ¿a qué precio aproximado te liquidás?",
      ...
      {
        question: "Mantenés una posición de $10,000 de exposición con un funding rate de 0.01% cada 8 horas en tu contra. ¿Aproximadamente cuánto pagás en un día completo (3 pagos)?",
        options: ["$0.30", "$3", "$30", "$300"],
        correctIndex: 1,
        explanation: "Cada pago: $10,000 × 0.0001 = $1. En un día hay 3 pagos de funding (cada 8h) → $1 × 3 = $3 por día.",
      },
      {
        question: "Si seguís la regla profesional de arriesgar siempre el mismo % de tu cuenta, ¿qué cambia realmente el apalancamiento?",
        options: [
          "Cuánto dinero real arriesgás en la operación",
          "Solo el margen que necesitás bloquear — el riesgo real en dólares no cambia si tu stop loss se respeta",
          "El precio de entrada de la operación",
          "El apalancamiento siempre aumenta el riesgo real, sin excepción",
        ],
        correctIndex: 1,
        explanation: "El error mental más común es pensar 'más apalancamiento = más riesgo'. En realidad, si definís tu tamaño de posición por el % de cuenta que arriesgás con tu SL, el apalancamiento solo determina cuánto margen bloqueás — no cuánto perdés si el SL se ejecuta.",
      },
      {
      ...
      {
        question: "Tenés una posición LONG a 20x con margen aislado. Tu stop loss está a 8% de distancia del precio de entrada. La liquidación (margen de mantenimiento ~0.5%) está a 1/20 − 0.5% = 4.5% de distancia. ¿Qué va a pasar si el precio cae?",
        options: [
          "Tu stop loss se ejecuta primero, como planeaste",
          "Te liquidás antes de que tu stop loss llegue a activarse — el SL nunca se ejecuta",
