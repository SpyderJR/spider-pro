...
export const STRATEGIES: StrategyDetail[] = [
  {
    ...
    howItWorks:
      "En vez de intentar adivinar el mínimo del mercado (algo que ni los profesionales logran de forma consistente), destinas una suma fija — digamos $100 — a comprar el mismo activo cada semana o cada mes, siempre en la misma fecha, pase lo que pase con el precio. Cuando el precio está alto compras menos unidades; cuando está bajo compras más. Con el tiempo, tu precio promedio de compra tiende a suavizarse por debajo de los picos y por encima de los mínimos absolutos.",
    example:
      "Supongamos que inviertes $100 por semana durante 10 semanas en un activo que se mueve así: $100, $90, $80, $70, $60, $70, $80, $90, $100, $110. Con DCA compras $1000 en total y terminas con más unidades acumuladas en las semanas baratas ($60-$80) que en las caras — tu precio promedio de compra queda en $85, más bajo que el precio inicial ($100) y bastante por debajo del pico final ($110). Compara eso con invertir los $1000 de una sola vez en la semana 1: hubieras comprado todo a $100, peor precio promedio que el DCA en este escenario particular de mercado bajista-luego-recuperación.",
    pros: [
  ...
  },
  {
    ...
    icon: "⚖️",
    oneLine: "Variante de DCA donde ajustas el monto de cada compra según qué tan lejos esté tu portafolio de una meta de crecimiento fija.",
    howItWorks:
      "En vez de invertir siempre el mismo monto (como en DCA clásico), defines una meta de valor de portafolio que crece cada período (por ejemplo, +$100 por mes). Si el mercado cayó y tu portafolio vale menos de lo esperado, inviertes más ese mes para 'ponerte al día' con la meta. Si el mercado subió y tu portafolio ya superó la meta, inviertes menos (o incluso vendes el excedente). El efecto es comprar más agresivamente en las caídas y frenar en las subas, de forma sistemática y sin depender de una decisión emocional en el momento.",
    example:
      "Meta: que tu portafolio valga $100 al final del mes 1, $200 al final del mes 2, $300 al final del mes 3. Si en el mes 2 el mercado cayó y tu portafolio del mes 1 ahora vale solo $80, necesitas invertir $120 ese mes (no $100) para llegar a la meta de $200. Si en cambio el mercado subió y tu portafolio ya vale $150 antes de invertir nada, solo necesitas poner $50 para llegar a $200.",
    pros: [
  ...
  },
  {
    ...
    howItWorks:
      "Defines de antemano qué % de tu portafolio quieres en cada activo. Cada cierto tiempo (mensual, trimestral), revisas los porcentajes reales — que cambiaron porque unos activos subieron más que otros — y vendes una porción del que más creció para comprar del que se quedó atrás, volviendo a los porcentajes originales.",
    example:
      "Empiezas con $1000: $600 en BTC (60%) y $400 en stablecoin (40%). Si BTC sube fuerte y tu portafolio pasa a valer $1000 en BTC + $400 en stable = $1400 total, ahora BTC es el 71% del portafolio. Rebalancear significa vender BTC por $160 (para volver al 60% = $840 de $1400) y quedarte con $560 en stablecoin (40%) — estás vendiendo parte de lo que subió y consolidando ganancia, de forma sistemática.",
    pros: [
  ...
  },
  {
    ...
    howItWorks:
      "Defines de antemano varios niveles de precio donde vas a vender una parte de tu posición — por ejemplo, 25% de la posición en cada uno de 4 niveles de precio crecientes. Nadie puede identificar el techo exacto de un ciclo de forma consistente; escalonar la salida reduce el arrepentimiento de vender todo demasiado pronto o de no vender nada y ver la posición devolverse toda la ganancia.",
    example:
      "Compraste a $30,000 con la idea de vender en la suba. Defines vender 25% en $45,000, 25% en $60,000, 25% en $75,000 y quedarte con el 25% final como posición de largo plazo sin fecha de venta. Si el precio nunca llega a $75,000, ya realizaste ganancias en los niveles anteriores. Si sigue subiendo mucho más allá de $75,000, todavía tienes el 25% restante expuesto a esa suba.",
    pros: [
  ...
  },
  {
    ...
    howItWorks:
      "Destinas la mayoría del capital (por ejemplo 80-90%) a una posición de convicción de largo plazo que casi no tocas (el 'núcleo', típicamente BTC u otro activo de mayor capitalización). El resto (10-20%) lo usas para posiciones más activas, tácticas o especulativas — practicar lectura técnica, operar rangos, o apostar a proyectos con mayor riesgo/potencial. Si el satélite sale mal, el daño está limitado por diseño; si sale bien, suma retorno extra sin poner en riesgo el núcleo.",
    example:
...
export const INVESTMENT_GUIDE: InvestmentStep[] = [
  {
    ...
    description:
      "Usa autenticación de dos factores (2FA) en todos tus exchanges, contraseñas únicas por servicio y, para montos relevantes, una wallet fría (hardware wallet) fuera de línea.",
  },
  {
    step: 2,
    title: "Elige una estrategia antes de comprar",
    description:
      "Decide de antemano si vas a hacer DCA, HODL, rebalanceo, o una combinación — antes de poner el primer dólar. Decidir en caliente, después de ver el precio moverse, es la forma más común de terminar con un plan improvisado.",
  },
  {
    step: 3,
    title: "Gestión de riesgo",
    description:
      "Nunca invertir más de lo que estás dispuesto a perder. Define de antemano qué porcentaje de tu portafolio total destinas a cripto según tu tolerancia al riesgo.",
  },
  {
    step: 4,
    title: "Dónde comprar",
    description:
      "Prefiere exchanges regulados y con buen historial de seguridad. Para montos grandes, considera retirar a una wallet propia — 'not your keys, not your coins'.",
  },
  {
    step: 5,
    title: "DYOR (Do Your Own Research)",
    description:
      "Antes de invertir en cualquier activo, entiende su propuesta de valor, su equipo, su tokenomics y su competencia. No inviertas solo por hype de redes sociales.",
  },
  {
    step: 6,
    title: "Fiscalidad",
    description:
      "Las ganancias de cripto suelen estar sujetas a impuestos en la mayoría de las jurisdicciones. Lleva registro de tus operaciones y consulta a un contador especializado.",
  },
];
