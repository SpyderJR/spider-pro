            ...
            <>
              ...
              <div className="panel p-5">
                ...
                <p className="text-[10px] text-slate-500 mt-3">
                  El tamaño de cada burbuja es proporcional al balance. Los 10 holders principales siempre muestran
                  su % del supply — adentro de la burbuja cuando es grande, o justo al lado cuando es pequeña — son
                  los mismos 10 que calculan la señal de concentración de arriba; el resto muestra su % al pasar el
                  mouse. Haz clic en cualquiera para abrir esa cartera en Tronscan.
