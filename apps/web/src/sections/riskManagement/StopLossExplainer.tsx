    ...
    <section id="que-es-stop-loss" className="scroll-mt-24 mb-10">
      ...
      <div className="panel p-5 mb-4">
        <p className="text-sm text-slate-300 leading-relaxed mb-3">
          Un <strong className="text-white">stop loss (SL)</strong> es una orden que dejas programada de
          antemano para que, si el precio se mueve en tu contra hasta un nivel determinado, la posición se
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-4">
        <div className="panel p-5">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Recién después de fijar ese nivel estructural calculas el tamaño de posición para que esa distancia
        ...
        <div className="panel p-5">
          ...
          <p className="text-sm text-slate-300 leading-relaxed mb-3">
            ...
            específicas de larguísimo plazo tipo DCA/HODL con capital que genuinamente puedes dejar quieto años
            sin necesitarlo — y aun así, un SL mental claro ("si pasa X, revisas la tesis") sigue siendo
            recomendable.
          </p>
          <p className="text-sm text-slate-400 leading-relaxed">
      ...
      <div className="panel p-5 mb-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bg-void-soft rounded-lg p-4 border border-neon-red/20">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Lo pones tan cerca del precio de entrada que el ruido normal del mercado (una mecha, una
          ...
          <div className="bg-void-soft rounded-lg p-4 border border-neon-red/20">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Lo pones tan lejos que, aunque técnicamente esté en un nivel estructural válido, la distancia
        ...
        <p className="text-xs text-slate-500 mt-4">
          ...
          define primero y el tamaño de posición se calcula después, nunca al revés — usa la calculadora justo
